...
<body>
    <?php
        ...
        if ($reservationStatus === 'success') {
            ...
            '<h1 class="text-center" style="font-family: Copperplate; color: whitesmoke;">PASSANI\'S</h1>' .
    ...
    <div class="reserve-container">
        <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family: Copperplate; color: whitesmoke;">-Reservation-</h1>
            <span class="sr-only"></span>
        </a>

        <!-- Home button -->
        <div class="text-center mb-4">
            <a href="/RestaurantProject/customerSide/home/home.php" class="btn btn-primary">Home</a>
        </div>
