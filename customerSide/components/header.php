            ...
            <div class="nav-bar">
                <div class="brand">
                    <a class="nav-link" href="../home/home.php#hero">
                        <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;">- ABC Restaurant - </h1><span
                            class="sr-only"></span>
                    </a>
                </div>
                <div class="nav-list">
                    ...
                    <div class="navbar-container">
                        ...
                        <div class="navbar">
                            <ul>
                                ...
                                ?>
                                <li><a href="<?= strpos($current_url, "localhost/RestaurantProject/customerSide/home/home.php") !== false ? "#hero" : "/RestaurantProject/customerSide/home/home.php" ?>" data-after="Home">Home</a></li>
                                <?php
                                ...
                                ?>
                                <li><a href="../gallery/gallery.php" data-after="Account">Gallery</a></li>
                                <li><a href="../offers/offers.php" data-after="Offers">Offers</a></li> <!-- New Offers Navigation -->
